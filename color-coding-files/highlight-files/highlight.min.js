...
;hljs.registerLanguage("javascript",e)})();/*! `python` grammar compiled for Highlight.js 11.6.0 */
...
;hljs.registerLanguage("python",e)})();/*! `json` grammar compiled for Highlight.js 11.6.0 */
...
;hljs.registerLanguage("plaintext",t)})();/*! `python-repl` grammar compiled for Highlight.js 11.6.0 */
(()=>{var a=(()=>{"use strict";return a=>({aliases:["pycon"],contains:[{
className:"meta.prompt",starts:{end:/ |$/,starts:{end:"$",subLanguage:"python"}
},variants:[{begin:/^>>>(?=[ ]|$)/},{begin:/^\.\.\.(?=[ ]|$)/}]}]})})()
;hljs.registerLanguage("python-repl",a)})();/*! `c` grammar compiled for Highlight.js 11.6.0 */
